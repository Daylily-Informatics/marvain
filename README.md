...
- [tests/test_route_smoke_api.py](tests/test_route_smoke_api.py) enumerates every FastAPI route in [functions/hub_api/api_app.py](functions/hub_api/api_app.py) and fails if any route returns `404` or `500`.
- [tests/test_route_smoke_gui.py](tests/test_route_smoke_gui.py) does the same for GUI and local-control routes in [functions/hub_api/app.py](functions/hub_api/app.py).

WebSocket entrypoints are covered separately:

- [tests/test_ws_connect_handler.py](tests/test_ws_connect_handler.py) covers `$connect`.
- [tests/test_ws_disconnect_handler.py](tests/test_ws_disconnect_handler.py) covers `$disconnect`.
- [tests/test_ws_message_handler.py](tests/test_ws_message_handler.py), [tests/test_ws_actions.py](tests/test_ws_actions.py), and [tests/test_ws_device_callbacks.py](tests/test_ws_device_callbacks.py) cover `$default` message handling and action callbacks.
...
- `functions/tool_runner` — executes approved actions and persists results
